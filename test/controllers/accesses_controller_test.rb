...
class AccessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create access" do
    assert_difference('Access.count') do
      post accesses_url, params: { access: { project_id: @access.project_id, user_id: @access.user_id } }
    end
  ...
  test "should update access" do
    patch access_url(@access), params: { access: { project_id: @access.project_id, user_id: @access.user_id } }
